# Generated by Powerlevel10k configuration wizard on 2022-01-21 at 23:43 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%B%F{red}%n%f%F{yellow}@%f%m'
  # Context format when in SSH without privileges: user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%B%n%F{yellow}@%f%F{magenta}%m%f'
